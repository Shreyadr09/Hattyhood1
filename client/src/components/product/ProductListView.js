  ...
  return (
    <div className="row">
      ...
      <div className={`col-xl-${col5 ? 5 : 4} col-lg-${col5 ? 5 : 4}`}>
        <div className="product-wrapper padingleft mb-30">
        ...
        <div className="product-content pro-list-content pr-0 mb-50">
          ...
          <div className="product-meta mb-10">
            <div className="pro-price">
              <span>{`₹${Number(product.mainPrice).toFixed(2)} INR`}</span>
              {product.price && (
          ...
          <p>
            ...
            accusantium dohique laudantium, totam rem aperiam, eaque ipsa
